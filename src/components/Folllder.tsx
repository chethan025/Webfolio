  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative flex items-center justify-center mb-4" style={{ height: "240px", width: "200px" }}>
          ...
          <div
            className="absolute w-14 h-6 bg-folder-tab rounded-t-md"
            style={{
          ...
          <div
            ...
            style={{
              top: "calc(50% - 48px + 4px)",
              background: "linear-gradient(135deg, rgba(248, 248, 248, 0.48) 0%, #00000026 50%)",
              transformOrigin: "bottom center",
              transform: isHovered ? "rotateX(25deg) translateY(8px)" : "rotateX(0deg)",
              transition: "transform 500ms cubic-bezier(0.34, 1.56, 0.64, 1)",
              zIndex: 31,
            ...
            >
              {projects.map((project, idx) => (
                <video
                  ...
                  className="w-full h-auto max-h-[70vh] modalbg object-contain bg-background flex-shrink-0"
                  style={{ minWidth: "100%" }}
                  autoPlay
                  muted
                  loop
